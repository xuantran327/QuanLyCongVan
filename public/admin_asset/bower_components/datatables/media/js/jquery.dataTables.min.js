    ...
    var O = function (g) {
                    ...
                    for (h = b.length; d < h; d++)
                        (c = b[d]),
                            ...
                            g.indexOf &&
                                -1 !== g.indexOf("&") &&
                                ((va.innerHTML = g),
                                (g = Yb ? va.textContent : va.innerText)),
        ...
        function Y(a) {
            ...
            if (q.outerWidth() < h) {
                ...
                if (
                    ...
                    N.width = s(v - f);
                ("" === c || "" !== e) &&
                    R(a, 1, "Possible column misalignment", 6);
            } else v = "100%";
            k.width = s(v);
            i.width = s(v);
            ...
            d &&
                ...
                t.offsetHeight < j.offsetHeight &&
                    (k.height = s(t.offsetHeight + b)));
            b = q.outerWidth();
            m[0].style.width = s(b);
            n.width = s(b);
        ...
        function wa(a) {
            ...
            if (d.bSort && d.bSortClasses) {
                ...
                for (f = b.length; d < f; d++)
                    (h = b[d].src),
                        g(C(a.aoData, "anCells", h)).removeClass(
                            c + (2 > d ? d + 1 : 3)
                        );
                d = 0;
                for (f = e.length; d < f; d++)
                    (h = e[d].src),
                        g(C(a.aoData, "anCells", h)).addClass(
                            c + (2 > d ? d + 1 : 3)
                        );
            }
            a.aLastSort = e;
        ...
        function cb(a) {
            g.each(
                ...
                function (b, c) {
                    ...
                    b.match(/^html\-/) &&
                        (w.type.search[b + a] = w.type.search.html);
                }
            );
        }
        function Mb(a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    x(
                        ...
                        "aoDrawCallback",
                        function () {
                            (k.bSorted || A(k) === "ssp" || v.bDeferRender) &&
                                wa(k);
                        },
                        "sc"
                    );
                    ...
                    0 === i.length || 0 === i.children().length
                        ...
                        : 0 < i.length &&
                          ((k.nTFoot = i[0]), da(k.aoFooter, k.nTFoot));
                    if (d.aaData)
        ...
        var Za = function (a, b) {
                ...
                for (h = a.length; f < h; f++) {
                    ...
                    for (j = d.length; i < j; i++)
                        (e = b(
                            "string" === typeof d[i] ? g.trim(d[i]) : d[i]
                        )) &&
                            e.length &&
                            c.push.apply(c, e);
                }
