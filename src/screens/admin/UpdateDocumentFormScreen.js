...
const UpdateDocumentFormScreen = props => {
  ...
  if (option) {
    const id = Object.values(props)[1].params.documentFormId;
  ...
  return (
    <View style={[s.m4]}>
      ...
      <TouchableOpacity
        ...
        onPress={() => updateDocumentForm(option)}>
        <Text style={styles.loginText}>Lưu thông tin</Text>
      </TouchableOpacity>
    </View>
  );
};
export default UpdateDocumentFormScreen;
