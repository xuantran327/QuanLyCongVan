...
const UpdateDispatchTypeScreen = props => {
  ...
  if (option) {
    const id = Object.values(props)[1].params.dispatchTypeId;
    ...
    <View style={[s.m4]}>
      <View style={styles.inputView}>
        <TextInput
          ...
          placeholder="Loại hình công văn..."
      ...
      <TouchableOpacity
        ...
        onPress={() => updateDispatchType(option)}>
        <Text style={styles.loginText}>Lưu thông tin</Text>
      </TouchableOpacity>
    </View>
  );
};
export default UpdateDispatchTypeScreen;
